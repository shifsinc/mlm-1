...
CREATE TABLE IF NOT EXISTS `yodafxpr_mlm_db`.`users_bonuses` (
  ...
  `user_id` INT(11) NOT NULL,
  `bonus_linear` DOUBLE NOT NULL DEFAULT '0',
  `bonus_binary` DOUBLE NOT NULL DEFAULT '0',
  `bonus_match` DOUBLE NOT NULL DEFAULT '0',
  `bonus_lead` DOUBLE NOT NULL DEFAULT '0',
  `bonus_lead_counter` INT(11) NOT NULL DEFAULT '0',
  `bonus_lead_counter_initial` INT(11) NOT NULL DEFAULT '0',
  `bonus_extra` DOUBLE NOT NULL DEFAULT '0',
