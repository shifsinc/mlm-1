...
module.exports = {
  POST: {
    ...
    [ API_PREFIX + '/admin/editNews' ]: authWrapper( adminWrapper( require('./methods/admin/editNews.js') ) ),
    [ API_PREFIX + '/admin/addFile' ]: authWrapper( adminWrapper( require('./methods/admin/addFile.js') ) ),
    [ API_PREFIX + '/admin/editFile' ]: authWrapper( adminWrapper( require('./methods/admin/editFile.js') ) ),
